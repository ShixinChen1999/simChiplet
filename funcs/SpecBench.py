...
#GEM5_DIR='/data/sxchen/workspace/Arch/gem5/'
#<PATH_TO_YOUR_GEM5_INSTALL>                          # Install location of gem5
#SPEC_DIR='/data/sxchen/workspace/Arch/Benchmarks/SPEC_CPU/cpu2006-1.2/benchspec/CPU2006/'
...
class Process(object):
    def __init__(self,pid):
        ...
        super().__init__()
    def run(self):
        cmd_line = ' '.join(self.cmd)
        #print(cmd_line)
        return cmd_line

def preprocess(spec_dir,workload="bzip2"):
    SPEC_DIR=spec_dir
    ...
    # REF CMDS
    bzip2.cmd = [bzip2.executable] + [fullpath+'input.combined', '280']
    # bzip2.cmd = [bzip2.executable] + [fullpath+'dryer.jpg', '30']
    ...
    return locals()[workload].run()

def spec_runner(spec_dir, workload="bzip2"):
    app = preprocess(spec_dir,workload)
    binary  = app.split(" ")[0]
    options= " ".join(app.split(" ")[1:])
    #print(binary)
    #print(options)
